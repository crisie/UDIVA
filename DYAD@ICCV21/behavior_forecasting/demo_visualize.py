...
sys.path.append("./lib")
from config import *
from annotations_parser import parse_face_at, parse_lhand_at, parse_rhand_at, parse_body_at, parse_gaze_at, is_lhand_visible, is_rhand_visible
...
if __name__ == '__main__':
    ...
    assert os.path.exists(annotations_path), "There is no annotations file for the session and task specified."
    assert os.path.exists(video_path), "There is no video file for the session and task specified."
